...
test('security settings page can be rendered', function () {
    ...
    $response->assertSee('Aún no hay passkeys');
...
test('security settings page renders without two factor when feature is disabled', function () {
    ...
    $this->actingAs($user)
        ...
        ->assertDontSee('Administra tus passkeys para iniciar sesión sin contraseña')
        ->assertDontSee('Agrega una passkey para iniciar sesión sin contraseña')
